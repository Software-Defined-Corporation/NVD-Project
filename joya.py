...
def send_digest_email():
    ...
    try:
        ...
        if length_of_results==0:
            ...
            logging.error("No new CVEs found")
            ...
            <body>
                <p>Hi!<br>
                <br>
                No new CVE found. Length of results = {length_of_results}<br>
                <br>
                Sincerely,<br>
                LANAIR CVE Notifier<br>
            ...
            server.quit()
            return
        elif len(results)>config.MAX_EMAILS_PER_INSTANCE:
        ...
        #    logging.error(length_of_results)
            for row in results:
                ...
                <p>Hi!<br>
                <br>
                TOO MANY CVEs to email: {length_of_results}<br>
                <br>
                CVE ID: """ + cve_id + """<br>
